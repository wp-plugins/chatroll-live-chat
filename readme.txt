...
<a href="http://chatroll.com/solutions/wordpress-chat-plugin">Chatroll</a> is a simple and flexible chat for your WordPress.
Use Chatroll as a <b>live chat</b> or <b>shoutbox</b> on the sidebar, posts and pages.

Check out the <a href="http://chatroll.com/solutions/wordpress-chat-plugin">Chatroll WordPress Demo</a>
...
**User Integration**
- Supports Single Sign-On (SSO) integration with your WordPress user profiles
...
1. Upload the whole `wp-chatroll` directory to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Follow the instructions on <a href='http://chatroll.com/create'>Chatroll</a> to create a Chatroll, customize the settings, and generate a WordPress shortcode.
4a. To add Chatroll to your sidebar, go to 'Appearance' -> 'Widgets' in WordPress admin and add "Chatroll" to one of the widget-ready areas of your site. Paste your Chatroll shortcode in the box and click "Save".
4b. To add Chatroll to posts or pages, simply paste the Chatroll shortcode where you want Chatroll to appear in your post or page.
...
Use the 'chatroll' shortcode to embed the Chatroll widget into a post or page.
You can easily generate a shortcode by going to your Chatroll's Settings page.

== Screenshots ==

Go to <a href='http://chatroll.com/solutions/wordpress-chat-plugin'>Chatroll</a> to see a live demo and get started.
